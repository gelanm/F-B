...
namespace Fleck.Tests
{
    ...
    public class WebSocketConnectionInfoTests
    {
        ...
        public void ShouldReadHeadersFromRequest()
        {
            ...
            var info = WebSocketConnectionInfo.Create(request, clientIp, clientPort, negotiatedSubProtocol,userid);
        ...
        public void ShouldReadSecWebSocketOrigin()
        {
            ...
            var info = WebSocketConnectionInfo.Create(request, null, 1, null,1);
