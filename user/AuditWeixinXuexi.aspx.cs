...
public partial class user_AuditWeixinXuexi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            BLLDALMod.BLL.techsBLL objgoods = new BLLDALMod.BLL.techsBLL();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow gr in GridView1.Rows)
        {
            ...
            if (chk.Checked)
            {
                BLLDALMod.Model.techs objGoods = new BLLDALMod.Model.techs();
