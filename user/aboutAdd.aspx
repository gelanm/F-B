...
<table width="98%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#3A76AF">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td height="25">
        <%--<CE:Editor id="WE_NewsContent" runat="server"  
...
<%--      FilesPath="~/CuteSoft_Client/CuteEditor/" AutoConfigure="Simple"  EditorWysiwygModeCss="../example.css" ThemeType="Office2003_BlueTheme"--%>
