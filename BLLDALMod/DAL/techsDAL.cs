...
namespace BLLDALMod.DAL
{
    ...
    public class techsDAL
    {
        ...
        public int Add(BLLDALMod.Model.techs model)
        {
            ...
            strSql.Append("insert into techs(");
            strSql.Append("Title,URL,ContentValidity,AddTime,State,type,Remark,UserId)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(BLLDALMod.Model.techs model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update techs set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from techs ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32,4)
			};
        ...
        public BLLDALMod.Model.techs GetModel(int id)
        {
            ...
            strSql.Append(" id,Title,URL,ContentValidity,AddTime,UpdateTime,State,type,Remark,UserId ");
            strSql.Append(" from techs ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { 
                  new MySqlParameter("@id", MySqlDbType.Int32,4)
            };
            parameters[0].Value = id;
            BLLDALMod.Model.techs model = new BLLDALMod.Model.techs();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Title,URL,ContentValidity,AddTime,UpdateTime,State,type,Remark,UserId ");
            strSql.Append(" FROM techs ");
            if (strWhere.Trim() != "")
            {
